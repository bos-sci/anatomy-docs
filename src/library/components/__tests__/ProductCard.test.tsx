  ...
  it("Renders an image with 50:50 ratio as the first child inside bsds-product-card when image ratio is set to '50:50'", () => {
    render(
      <ProductCard
        ...
        linkTo="docs-demo-link"
        image={<Image src="https://images.unsplash.com/photo-1583160247711-2191776b4b91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2071&q=80" alt="Golden retriever puppy." ratio="50:50"/>}
      />
    );
